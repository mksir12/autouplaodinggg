...
def is_auto_mode():
    return bool(util.strtobool(os.getenv('auto_mode', "False")))

def is_force_auto_upload():
    return bool(util.strtobool(os.getenv('force_auto_upload', "False")))

def is_check_dupes():
    return bool(util.strtobool(os.getenv('check_dupes', "False")))

def is_containerized():
    return bool(util.strtobool(os.getenv("IS_CONTAINERIZED", "False")))

def is_full_disk_supported():
    return bool(util.strtobool(os.getenv("IS_FULL_DISK_SUPPORTED", "False")))

def is_live():
    return bool(util.strtobool(os.getenv('live', "False")))

def is_readble_temp_data_needed():
    return bool(util.strtobool(os.getenv("readable_temp_data", "False")))
...
def is_translation_needed():
    return bool(util.strtobool(os.getenv('translation_needed', "False")))
...
def is_no_spoiler_screenshot():
    return bool(util.strtobool(os.getenv("no_spoilers", "False")))
...
def is_post_processing_needed():
    return bool(util.strtobool(os.getenv('enable_post_processing', "False")))

def is_type_based_move_enabled():
    return bool(util.strtobool(os.getenv('enable_type_base_move', "False")))
...
def is_dynamic_tracker_selection_needed():
    return bool(util.strtobool(os.getenv("dynamic_tracker_selection", "False")))
